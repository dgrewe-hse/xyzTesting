...
class TestCalculatorAddition(unittest.TestCase):
    ...
    def test_add_no_values(self):
        ...
        self.assertEqual(
            self.calculator.add(), 0.0, "Adding no values should return 0.0"
        )

    def test_add_single_value(self):
        """Test adding a single number (should return the number itself)."""
        self.assertEqual(
            self.calculator.add(5.0),
            5.0,
            "Adding a single number should return the number itself",
        )

    def test_add_positive_numbers(self):
        """Test adding multiple positive numbers (e.g., 1.0 + 2.0 + 3.0)."""
        self.assertEqual(
            self.calculator.add(1.0, 2.0, 3.0),
            6.0,
            "Adding positive numbers should return 6.0",
        )
    ...
    def test_add_negative_numbers(self):
        ...
        self.assertEqual(
            self.calculator.add(-1.0, -2.0, -3.0),
            -6.0,
            "Adding negative numbers should return -6.0",
        )
    ...
    def test_add_mixed_numbers(self):
        ...
        self.assertEqual(
            self.calculator.add(1.0, -2.0, 3.0),
            2.0,
            "Adding mixed numbers should return 2.0",
        )
...
class TestCalculatorSubtraction(unittest.TestCase):
    ...
    def test_subtract_no_values(self):
        ...
        self.assertEqual(
            self.calculator.subtract(), 0.0, "Subtracting no values should return 0.0"
        )

    def test_subtract_single_value(self):
        """Test subtracting a single number (should return the number itself)."""
        self.assertEqual(
            self.calculator.subtract(5.0),
            5.0,
            "Subtracting a single number should return the number itself",
        )

    def test_subtract_positive_numbers(self):
        """Test subtracting multiple positive numbers (e.g., 10.0 - 3.0 - 2.0)."""
        self.assertEqual(
            self.calculator.subtract(10.0, 3.0, 2.0),
            5.0,
            "Subtracting positive numbers should return 5.0",
        )
    ...
    def test_subtract_negative_numbers(self):
        ...
        self.assertEqual(
            self.calculator.subtract(-10.0, -3.0, -2.0),
            -5.0,
            "Subtracting negative numbers should return -5.0",
        )
    ...
    def test_subtract_mixed_numbers(self):
        ...
        self.assertEqual(
            self.calculator.subtract(10.0, -3.0, 2.0),
            11.0,
            "Subtracting mixed numbers should return 11.0",
        )
...
class TestCalculatorMultiplication(unittest.TestCase):
    ...
    def test_multiply_no_values(self):
        ...
        self.assertEqual(
            self.calculator.multiply(), 1.0, "Multiplying no values should return 1.0"
        )

    def test_multiply_single_value(self):
        """Test multiplying a single number (should return the number itself)."""
        self.assertEqual(
            self.calculator.multiply(5.0),
            5.0,
            "Multiplying a single number should return the number itself",
        )

    def test_multiply_positive_numbers(self):
        """Test multiplying multiple positive numbers (e.g., 2.0 * 3.0 * 4.0)."""
        self.assertEqual(
            self.calculator.multiply(2.0, 3.0, 4.0),
            24.0,
            "Multiplying positive numbers should return 24.0",
        )
    ...
    def test_multiply_negative_numbers(self):
        ...
        self.assertEqual(
            self.calculator.multiply(-2.0, -3.0, -4.0),
            -24.0,
            "Multiplying negative numbers should return -24.0",
        )
    ...
    def test_multiply_mixed_numbers(self):
        ...
        self.assertEqual(
            self.calculator.multiply(2.0, -3.0, 4.0),
            -24.0,
            "Multiplying mixed numbers should return -24.0",
        )
...
class TestCalculatorDivision(unittest.TestCase):
    ...
    def test_divide_no_values(self):
        ...
        self.assertEqual(
            self.calculator.divide(), 1.0, "Dividing no values should return 1.0"
        )
    ...
    def test_divide_single_value(self):
        ...
        self.assertEqual(
            ...
            5.0,
            "Dividing a single number should return the number itself",
        )

    def test_divide_positive_numbers(self):
        """Test dividing multiple positive numbers (e.g., 100.0 / 5.0 / 2.0)."""
        self.assertEqual(
            self.calculator.divide(100.0, 5.0, 2.0),
            10.0,
            "Dividing positive numbers should return 10.0",
        )
    ...
    def test_divide_negative_numbers(self):
        ...
        self.assertEqual(
            self.calculator.divide(-100.0, -5.0, -2.0),
            -10.0,
            "Dividing negative numbers should return -10.0",
        )
    ...
    def test_divide_mixed_numbers(self):
        ...
        self.assertEqual(
            self.calculator.divide(100.0, -5.0, 2.0),
            -10.0,
            "Dividing mixed numbers should return -10.0",
        )
