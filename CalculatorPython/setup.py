...
setup(
    ...
    setup_requires=['pytest-runner'],  # pytest-runner will allow you to run tests using `python setup.py test`
    extras_require={
        'dev': ['pytest'],  # This will ensure pytest is installed for development or testing
    },
